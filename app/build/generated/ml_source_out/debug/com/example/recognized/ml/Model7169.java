...
public final class Model7169 {
  @NonNull
  private final Model model;

  private Model7169(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "Model71-69.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Model7169 newInstance(@NonNull Context context) throws IOException {
    return new Model7169(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Model7169 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Model7169(context, options);
  }
