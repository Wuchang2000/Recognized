package com.example.recognized.ml;
...
public final class Model7573 {
  @NonNull
  private final Model model;

  private Model7573(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "Model75-73.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Model7573 newInstance(@NonNull Context context) throws IOException {
    return new Model7573(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Model7573 newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new Model7573(context, options);
  }
